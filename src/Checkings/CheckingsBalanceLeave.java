...
/*The CheckingsBalanceLeave class is created as a JFrame by extending the JFrame class.
The class also implements the ActionListner and MouseListender interfaces
in order for each button to use the interfaces.*/

public class CheckingsBalanceLeave extends JFrame implements ActionListener, MouseListener {
    ...
    public CheckingsBalanceLeave() {

        // Instantiating the leaveLabel variable as a new JLabel.
        leaveLabel = new JLabel();
        leaveLabel.setText("Are you sure you want to leave?");
        leaveLabel.setFont(new Font("Engebrechtre", Font.BOLD, 29));
        leaveLabel.setBounds(86, 45, 335, 30);
        leaveLabel.setForeground(new Color(253, 252, 202));

        // Instantiating the yesButton as a new JButton that will open a new window when
        // the user
        // clicks on it.
        ...
        // Instantiating the noButton as a new JButton that will open a new window when
        // the user
        // clicks on it.
