...
/*The CheckingsDepositLeave class is created as a JFrame by extending the JFrame class.
The class also implements the ActionListner and MouseListender interfaces
in order for each button to use the interfaces.*/

public class CheckingsDepositLeave extends JFrame implements ActionListener, MouseListener {
